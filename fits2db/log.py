...
def configure_logger(
    ...
    if debug_file is not None:
        debug_formatter = logging.Formatter(LOG_FORMATS['DEBUG'], datefmt=DATE_FORMAT)
    ...
    log_formatter = logging.Formatter(LOG_FORMATS.get(level, LOG_FORMATS['DEBUG']), datefmt=DATE_FORMAT)
